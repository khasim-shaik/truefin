...
def user_input_form():
    ...
    return home_price, down_payment, interest_rate, tax_rate, maintenance_rate, pmi_rate, insurance_rate, years_to_hold, rental_income, hoa_payment, avg_appreciation_per_year, rent_cost
